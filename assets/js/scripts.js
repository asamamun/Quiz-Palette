...
const quizData = [
  {
    name: "Math",
    category: "math",
    description: "Challenge your math skills with engaging quizzes.",
  },
  {
    name: "Admission",
    category: "admission",
    description: "Prepare for university and college admission tests.",
  },
  {
    name: "Job Preparation",
    category: "job",
    description: "Ace your job interviews with practice quizzes.",
  },
];
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  leaderboardData.forEach((leader) => {
    ...
    const badgeText =
      leader.badge !== "None"
        ? `<span class="${badgeClass}">${leader.badge}</span>`
        : "None";
  ...
  document
    .querySelectorAll(".nav-link, .breadcrumb-item a")
    .forEach((anchor) => {
  ...
  searchInput.addEventListener("input", function () {
    ...
    if (filteredQuizzes.length === 0) {
      quizList.innerHTML =
        '<div class="col-12"><p class="text-center">No quizzes found.</p></div>';
    }
