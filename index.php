...
<section id="quizzes" class="categories py-5">
    <div class="container">
        ...
        <div id="quizList" class="row">
            ...
            <div class="col-md-4 mb-4" data-aos="zoom-in-left">
                <div class="card h-100 shadow-sm quiz-card">
                    <div class="card-body">
...
<!-- Total User & Quizes Card Section -->
    ...
    <div class="row g-4 justify-content-center">
        <div class="col-md-4 col-sm-6" data-aos="fade-right">
            <div class="ds-stat-card">
                ...
                <div class="ds-stat-count" id="userCount"><?= $totalUsers ?? 0; ?></div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6" data-aos="fade-left">
            <div class="ds-stat-card">
                ...
                <div class="ds-stat-count" id="quizCount"><?= $totalQuizzes ?? 0; ?></div>
            </div>
        </div>
    </div>
</div>
