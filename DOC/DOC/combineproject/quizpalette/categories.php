                ...
                <div class="row g-4">
                        ...
                        <a href="quiz4.php" class="card-link-wrapper">
                            <div class="icon-card h-100">
                                <div class="icon-container">
                                    <img src="assets/images/math.png-444b34-128c.png" alt="Class 1-8" class="icon-img">
                                </div>
                                <div class="card-body">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <a href="quiz4.php" class="card-link-wrapper">
                            <div class="icon-card h-100">
                                <div class="icon-container">
                                    <img src="assets/images/math.png-444b34-128c.png" alt="Class 9-10" class="icon-img">
                                </div>
                                <div class="card-body">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <a href="quiz4.php" class="card-link-wrapper">
                            <div class="icon-card h-100">
                                <div class="icon-container">
                                    <img src="assets/images/math.png-444b34-128c.png" alt="Cadet Coaching" class="icon-img">
                                </div>
                                <div class="card-body">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <a href="quiz4.php" class="card-link-wrapper">
                            <div class="icon-card h-100">
                                <div class="icon-container">
                                    <img src="assets/images/math.png-444b34-128c.png" alt="Admission" class="icon-img">
                                </div>
                                <div class="card-body">
